        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="Weather app"
              description="Used Weather App leverages the Weather API to display live weather updates from around the globe. It provides real-time information on current climate conditions and shows detailed insights into the weather stages.the plant disease dataset from Kaggle and trained a image classifer model using 'PyTorch' framework using CNN and Transfer Learning with 38 classes of various plant leaves. The model was successfully able to detect diseased and healthy leaves of 14 unique plants. I was able to achieve an accuracy of 98% by using Resnet34 pretrained model."
