        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              description="Blockchain Tracker is a system that tracks products through all stages by generating a unique hash for each product. It ensures transparency for all members of the organization, allowing them to monitor the entire product lifecycle securely and efficiently.Online code and markdown editor build with react.js. Online Editor which supports html, css, and js code with instant view of website. Online markdown editor for building README file which supports GFM, Custom Html tags with toolbar and instant preview.Both the editor supports auto save of work using Local Storage"
