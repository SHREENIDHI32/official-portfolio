...
import leaf from "../../Assets/Projects/weather-image.png";
import emotion from "../../Assets/Projects/emotion.png";
import editor from "../../Assets/Projects/blockchain-image.png";
import chatify from "../../Assets/Projects/fooldel-image.png";
import suicide from "../../Assets/Projects/suicide.png";
import bitsOfCode from "../../Assets/Projects/buzzboard-image.png";
        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/SHREENIDHI32/DINNER_DIVE.git"
              demoLink="https://dinner-dive.vercel.app/"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/SHREENIDHI32/BUZZ_BOARD.git"
              demoLink=""
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/SHREENIDHI32/blockchain-tracker.git"
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              description="Used Weather App leverages the Weather API to display live weather updates from around the globe.It provides real-time information on current climate conditions and shows detailed insights into the weather stages."
               ghLink="https://github.com/SHREENIDHI32/weather-app.git"
